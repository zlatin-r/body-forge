...
from workouts.forms import (CreateWorkoutForm, CreateWorkoutTypeForm,
    # CreateExerciseForm, CreateMuscleGroupForm, CreateSetForm
                            )
...
class CreateWorkoutView(LoginRequiredMixin, UserObjectOwnerMixin, CreateView):
    ...
    def get_success_url(self):
        return reverse_lazy('wt-details', kwargs={'pk': self.object.pk})
...
#
#     def get_success_url(self):
#         return reverse_lazy('wt-details', kwargs={'pk': self.workout.pk})
#
#     def get_context_data(self, **kwargs):
#         context = super().get_context_data(**kwargs)
...
#
#     def get_success_url(self):
#         return reverse_lazy('wt-details')
#
#
